      ...
      <main className="flex item-center justify-center w-full min-h-screen bg-[#f5f5f5f5]">
        <div className="mt-[100px] flex flex-col">
          ...
          <section className="flex flex-col-reverse md:flex-row px-4">
            <main className="flex-1 pl-[250px] w-[100%]">
              <div className="w-full h-[175px] border bg-white rounded-lg">
              ...
              <button
                className="border bg-[#077369] w-3/4 h-[60px] my-[18px]  rounded-[4px] text-[#ffffff] text-center font-bold leading-[24px] text-[16px]"
                // onClick={() => alert("hello")}
              >
                Contact Seller
              </button>
              ...
              <div className="h-[480px] w-full pl-[24px]">
                <section className="mt-[24px]">
                  ...
                  <div className="flex space-x-2.5">
                    ...
                    />
                    <p className="mb-[4px] text-[24px] leading-[24px]">Grey</p>
                  </div>
                </section>
                <hr className="w-1/2" />
